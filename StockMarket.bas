...
For i = 2 To Lastrow
    If WS.Cells(i + 1, 1).Value <> WS.Cells(i, 1).Value Then
      ...
      ' Create the summary table
        ...
        'Increment the summary table Index
...
'Variable intitializations for the 2nd summary table
 Max = 0
 Min = 0
 Min_i = 0
 Greatest_Volume = 0
 
'Calculate the Max and Min values from Percent Change and also the Max Volume and display it as a 2nd summary table
